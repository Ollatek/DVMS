<?php
    ...
    if(isset($_POST['admin_login']))
    {
        ...
        if($rs)
           ...
           echo "<script>setTimeout(function () { swal('Success', 'Access Granted', 'success'); }, 100);</script>";
        echo "<script>setTimeout(function () { window.location.href = 'his_admin_dashboard.php'; }, 1500);</script>";
    } else {
...
<head>
        <meta charset="utf-8" />
        <title>Drug Verification Management System</title>
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card bg-pattern">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center w-75 m-auto">
                                    <a href="index.php">
                                        <span><img src="assets/images/dvms-dark.png" alt="" height="32"></span>
                                    </a>
                                ...
                                <div class="text-center">
                                    ...
                                    <ul class="social-list list-inline mt-3 mb-0">
                                        ...
                                        <li class="list-inline-item">
                                            <a href="https://accounts.google.com/" class="social-list-item border-danger text-danger"><i class="mdi mdi-google"></i></a>
                                        </li>
                                        <li class="list-inline-item">
                                            <a href="https://twitter.com/" class="social-list-item border-info text-info"><i class="mdi mdi-twitter"></i></a>
                                        </li>
                                        <li class="list-inline-item">
                                            <a href="https://github.com/login" class="social-list-item border-secondary text-secondary"><i class="mdi mdi-github-circle"></i></a>
                                        </li>
                                    </ul>
                                </div> 
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
								...
								<p class ="text-white-50">Go back to <a href="../../index.php" class="text-white ml-1"><b>Home Page</b><a/></p>
                            </div> <!-- end col -->
                        </div>
                        <!-- end row -->
